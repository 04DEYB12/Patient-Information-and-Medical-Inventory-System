            ...
            <form id="studentForm" method="POST" action="../Functions/patientFunctions.php">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                    ...
                    <div style="display: flex; gap: 1rem; align-items: center;">
                        <button type="button" id="editStudentBtn" class="btn btn-primary" style="padding: 0.375rem 0.75rem; font-size: 0.875rem;">
                            <i class="fas fa-edit"></i> Edit
                        </button>
                        <button type="submit" id="saveStudentBtn" class="btn btn-success" style="padding: 0.375rem 0.75rem; font-size: 0.875rem; display: none;">
                            <i class="fas fa-save"></i> Save Changes
                        </button>
                        <button type="button" id="cancelEditBtn" class="btn btn-secondary" style="padding: 0.375rem 0.75rem; font-size: 0.875rem; display: none;">
                            Cancel
                        </button>
                ...
                <div id="studentProfileContent">
                    ...
                    <div class="tabs" style="margin-bottom: 1.5rem; border-bottom: 1px solid #e5e7eb;">
                        ...
                        <button type="button" class="tab-btn" data-tab="emergency">Emergency Contact</button>
                        <button type="button" class="tab-btn" data-tab="medical">Medical Info</button>
                    </div>
